export const Icons = {
  groups: {
    ...
    class: 'h-8 w-8 shrink-0 fill-orange-400 dark:fill-orange-300',
    width: 48,
    height: 48,
  ...
  tools: {
    ...
    class:
      'h-6 w-6 shrink-0 fill-neutral-700 hs-tab-active:fill-orange-400 dark:fill-neutral-300 dark:hs-tab-active:fill-orange-300 md:h-7 md:w-7',
    width: 48,
    height: 48,
    viewBox: '0 -960 960 960',
  },
  ...
  puzzle: {
    ...
    class: 'h-8 w-8 shrink-0 text-yellow-500 dark:text-yellow-400',
    viewBox: '0 0 24 24',
    fill: 'none',
    strokeWidth: '1.5',
    strokeLinecap: 'round',
  ...
  /* --- Gwave Innovation feature / service icons (Material Symbols) --- */
  settings: {
    paths: [
      {
        d: 'M692-568L802-551 802-409 692-392 758-302 658-202 568-268 551-158 409-158 392-268 302-202 202-302 268-392 158-409 158-551 268-568 202-658 302-758 392-692 409-802 551-802 568-692 658-758 758-658Z M480-590a110 110 0 1 0 0 220 110 110 0 1 0 0-220Z',
        fillRule: 'evenodd',
      },
    ],
    class: 'h-8 w-8 shrink-0 fill-yellow-500 dark:fill-yellow-400',
    width: 48,
    height: 48,
    viewBox: '0 -960 960 960',
  },
  ...
  scale: {
    paths: [
      {
        d: 'M674-429L685-359 687-306 680-261 663-224 634-194 591-167 530-144 476-132 460-141 452-156 452-348 348-452 156-452 138-463 132-480 148-544 172-601 200-642 232-668 269-682 314-687 369-684 429-672 472-727 519-774 576-817 634-851 695-877 764-896 841-907 891-905 901-897 907-883 903-807 887-725 859-650 827-590 783-529 731-476 674-429Z M510-342L508-196 580-225 604-241 619-259 628-284 631-316 622-397 510-342Z M397-622L366-628 318-631 284-628 259-619 241-604 225-580 196-508 341-508 397-622Z M393-487L487-393 585-440 663-491 703-526 740-565 771-606 798-651 820-701 835-749 846-798 851-851 776-841 704-820 637-789 575-748 524-701 480-647 435-574 393-487Z M160-320L191-339 226-348 263-345 296-332 323-309 341-278 349-243 345-206 334-181 318-158 296-139 266-120 224-102 177-87 110-73 91-74 77-85 72-101 90-187 121-267 140-298 160-320Z M135-135L163-141 215-159 249-175 274-193 287-212 293-235 289-258 278-276 259-288 236-293 213-288 194-275 177-253 161-222 135-135Z',
        fillRule: 'nonzero',
      },
    ],
    class: 'h-8 w-8 shrink-0 fill-yellow-500 dark:fill-yellow-400',
  ...
  chip: {
    paths: [
      {
        d: 'M300-710h360v460H300v-460Zm80 80v300h200v-300H380ZM100-680h200v56H100v-56Zm0 114h200v56H100v-56Zm0 116h200v56H100v-56Zm0 114h200v56H100v-56ZM660-680h200v56H660v-56Zm0 114h200v56H660v-56Zm0 116h200v56H660v-56Zm0 114h200v56H660v-56Z',
        fillRule: 'evenodd',
      },
    ],
    class: 'h-8 w-8 shrink-0 fill-yellow-500 dark:fill-yellow-400',
